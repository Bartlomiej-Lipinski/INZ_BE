...
public class GenerateCodeToJoinGroupTest : TestBase
{
    ...
    public async Task Handle_ShouldGenerateUniqueCode()
    {
        ...
        result.Should().BeOfType<Microsoft.AspNetCore.Http.HttpResults.Ok<ApiResponse<GenerateCodeToJoinGroup.GenerateCodeResponse>>>();
        var okResult = result as Microsoft.AspNetCore.Http.HttpResults.Ok<ApiResponse<GenerateCodeToJoinGroup.GenerateCodeResponse>>;
